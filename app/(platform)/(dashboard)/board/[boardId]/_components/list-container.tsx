...
const ListContainer = ({ boardId, data }: ListContainerProps) => {
  ...
  // Optimistic Update when Drag & Drop
  useEffect(() => {
    setOrderedData(data);
  }, [data]);
  ...
  const onDragEnd = (result: any) => {
    ...
    if (type === "list") {
      ...
      // Trigger a POST request to save the order of the lists
    ...
    if (type === "card") {
      ...
      // If the list is empty and card exist in the source list
      ...
      if (source.droppableId === destination.droppableId) {
        ...
        // Trigger a POST request to save the order of the cards
